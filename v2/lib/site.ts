export const SITE_NAME = "Think Beyond Tax";
export const SITE_TAGLINE =
  "Independent UAE accounting, bookkeeping and tax professionals";

export const EMAIL = "info@thinkbeyondtax.com";
export const PHONE_DISPLAY = "+971 50 265 1430";
...
export const TRADEMARK_DISCLAIMER =
  "Interfaces shown are simplified, fictional recreations for illustration only. All product names, logos and trademarks belong to their respective owners. Think Beyond Tax is not affiliated with, certified by, or endorsed by any software provider or the Federal Tax Authority.";

export const COLLECTIVE_DISCLAIMER =
